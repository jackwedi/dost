...
class BirthdayModal extends React.Component {
	...
	checkInput() {
		const incorrectDay =
			isNaN(this.parsedDay) || !isFinite(this.state.day) || this.state.day.length > 2 || this.parsedDay > 31 || !this.parsedDay;
			...
			>
				...
				<Modal.Content>
					...
					<Form error={this.state.futureDOB}>
						...
						<Message error header="Wrong birthday 👺" content="Please specify a correct date. (This one is in the future)" />
					</Form>
				</Modal.Content>
				<Modal.Actions>
